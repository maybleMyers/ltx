...
def _offload_transformer_args_to_cpu(args: TransformerArgs) -> TransformerArgs:
    ...
    return replace(args,
        ...
        prompt_timestep=to_pinned(args.prompt_timestep),
        self_attention_mask=to_pinned(args.self_attention_mask),
    )
...
def _move_transformer_args_to_device(args: TransformerArgs, device: torch.device) -> TransformerArgs:
    ...
    return replace(args,
        ...
        prompt_timestep=to_device(args.prompt_timestep),
        self_attention_mask=to_device(args.self_attention_mask),
    )
